...
#SBATCH --job-name=llama-13-nonchat
#SBATCH --error=/home/abhinavr/logs/llama-13.%j.err
#SBATCH --output=/home/abhinavr/logs/llama-13.%j.out
...
text-generation-launcher --model-id meta-llama/Llama-2-13b-hf  --port 8088 --master-port 41024 --huggingface-hub-cache /data/tir/projects/tir7/user_data/abhinavr/hf_home/hub/ --shard-uds-path /scratch/abhinavr/tgi-uds-socket-2 
