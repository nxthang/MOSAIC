...
#SBATCH --mem=32Gb
#SBATCH -t 8:00:00              # time limit: (D-HH:MM) 
#SBATCH --job-name=chat-13
#SBATCH --error=/home/abhinavr/logs/chat-13.%j.err
#SBATCH --output=/home/abhinavr/logs/chat-13.%j.out
...
text-generation-launcher --model-id meta-llama/Llama-2-13b-chat-hf  --port 8088 --master-port 41024 --huggingface-hub-cache /data/tir/projects/tir7/user_data/abhinavr/hf_home/hub/ --shard-uds-path /scratch/abhinavr/tgi-uds-socket-2 
