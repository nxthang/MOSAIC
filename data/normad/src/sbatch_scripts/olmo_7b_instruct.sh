...
#SBATCH --job-name=olmo-7b-ins
#SBATCH --error=/home/abhinavr/logs/olmo-7i.%j.err
#SBATCH --output=/home/abhinavr/logs/olmo-7i.%j.out
...
text-generation-launcher --model-id allenai/OLMo-7B-Instruct --port 8088 --master-port 41024 --huggingface-hub-cache /data/tir/projects/tir7/user_data/abhinavr/hf_home/hub/ --shard-uds-path /scratch/abhinavr/tgi-uds-socket-2 
