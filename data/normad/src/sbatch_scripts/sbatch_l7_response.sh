...
#SBATCH --job-name=l7-inference
#SBATCH --error=/home/abhinavr/logs/l7-infer.%j.err
#SBATCH --output=/home/abhinavr/logs/l7-infer.%j.out
...
python -m src.response_collection.get_response story_inference.block_user_input=false story_inference.model_name="meta-llama/Llama-2-7b-chat-hf" story_inference.model_url="http://babel-3-15:8088" story_inference.value_condition=true story_inference.rot_condition=true
